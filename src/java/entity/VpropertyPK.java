 ...
 */
@Embeddable
public class VpropertyPK implements Serializable {
    ...
    public VpropertyPK(BigInteger idinstance, BigInteger idobject, BigInteger idproperty) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof VpropertyPK)) {
            return false;
        }
        VpropertyPK other = (VpropertyPK) object;
    ...
    public String toString() {
        return "entity.VpropertyPK[ idinstance=" + idinstance + ", idobject=" + idobject + ", idproperty=" + idproperty + " ]";
    }
