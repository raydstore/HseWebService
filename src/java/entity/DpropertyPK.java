 ...
 */
@Embeddable
public class DpropertyPK implements Serializable {
    ...
    public DpropertyPK(BigInteger idinstance, BigInteger idobject, BigInteger idproperty) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DpropertyPK)) {
            return false;
        }
        DpropertyPK other = (DpropertyPK) object;
    ...
    public String toString() {
        return "entity.DpropertyPK[ idinstance=" + idinstance + ", idobject=" + idobject + ", idproperty=" + idproperty + " ]";
    }
