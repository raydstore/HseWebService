 ...
 */
@Embeddable
public class IpropertyPK implements Serializable {
    ...
    public IpropertyPK(BigInteger idinstance, BigInteger idobject, BigInteger idproperty) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof IpropertyPK)) {
            return false;
        }
        IpropertyPK other = (IpropertyPK) object;
    ...
    public String toString() {
        return "entity.IpropertyPK[ idinstance=" + idinstance + ", idobject=" + idobject + ", idproperty=" + idproperty + " ]";
    }
