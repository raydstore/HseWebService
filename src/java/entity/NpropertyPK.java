 ...
 */
@Embeddable
public class NpropertyPK implements Serializable {
    ...
    public NpropertyPK(BigInteger idinstance, BigInteger idobject, BigInteger idproperty) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof NpropertyPK)) {
            return false;
        }
        NpropertyPK other = (NpropertyPK) object;
    ...
    public String toString() {
        return "entity.NpropertyPK[ idinstance=" + idinstance + ", idobject=" + idobject + ", idproperty=" + idproperty + " ]";
    }
