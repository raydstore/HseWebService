...
@Stateless
@Path("dproperty")
public class DpropertyFacadeREST extends AbstractFacade<Dproperty> {
    @PersistenceContext(unitName = "HseWebServicePU")
    private EntityManager em;

    private DpropertyPK getPrimaryKey(PathSegment pathSegment) {
        /*
         ...
         */
        entity.DpropertyPK key = new entity.DpropertyPK();
    ...
    public DpropertyFacadeREST() {
        super(Dproperty.class);
    }

    @POST
    @Override
    @Consumes({"application/json"})
    public void create(Dproperty entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({"application/json"})
    public void edit(@PathParam("id") PathSegment id, Dproperty entity) {
        super.edit(entity);
    }
    ...
    public void remove(@PathParam("id") PathSegment id) {
        entity.DpropertyPK key = getPrimaryKey(id);
    ...
    public Dproperty find(@PathParam("id") PathSegment id) {
        entity.DpropertyPK key = getPrimaryKey(id);
    ...
    @Path("{from}/{to}")
    @Produces({"application/json"})
    public List<Dproperty> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
